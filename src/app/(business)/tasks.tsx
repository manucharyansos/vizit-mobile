...
export default function TasksScreen() {
  ...
  const { canManage, isStaff } = useBusinessPermissions();
  ...
  const update = useMutation({ mutationFn: ({ item, status }: { item: BusinessTask; status: BusinessTask['status'] }) => businessApi.updateTask(item.id, { status }, isStaff), onSuccess: () => void cache.invalidateQueries({ queryKey: ['business-tasks'] }), onError: fail });
