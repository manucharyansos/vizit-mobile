...
const en = {
  ...
  bookingSuccess: 'Booking request created', bookingCodeHint: 'Keep the booking code. A 4-digit OTP is required before viewing or changing this booking.',
  bookingsBody: 'Your verified bookings will appear here. Managing them requires the booking code and 4-digit OTP.', profileBody: 'Sign in as a client or switch to your business workspace.',
...
export const translations: Record<Locale, Record<TranslationKey, string>> = {
  ...
  hy: {
    ...
    bookingSuccess: 'Ամրագրման հարցումը ստեղծվեց', bookingCodeHint: 'Պահպանիր ամրագրման կոդը․ ամրագրումը տեսնելու կամ փոխելու համար անհրաժեշտ է նաև 4-նիշ OTP։',
    bookingsBody: 'Այստեղ կերևան հաստատված ամրագրումները։ Կառավարման համար պարտադիր են ամրագրման կոդը և 4-նիշ OTP-ն։', profileBody: 'Մուտք գործիր որպես հաճախորդ կամ անցիր բիզնես աշխատանքային բաժին։',
  ...
  ru: {
    ...
    bookingSuccess: 'Запись создана', bookingCodeHint: 'Сохраните код записи. Для просмотра или изменения также потребуется 4-значный OTP.',
    bookingsBody: 'Здесь появятся подтверждённые записи. Для управления нужны код записи и 4-значный OTP.', profileBody: 'Войдите как клиент или перейдите в рабочее пространство бизнеса.',
